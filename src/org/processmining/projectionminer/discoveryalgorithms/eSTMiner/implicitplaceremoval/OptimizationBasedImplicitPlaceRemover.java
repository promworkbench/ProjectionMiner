...
public class OptimizationBasedImplicitPlaceRemover extends AbstractImplicitPlacesRemover {
    ...
    private boolean isImplicitByLPP(int currP, ArrayList<MyPlace> places, String[] transitions, ArrayList<Integer[]> preIncMatrix, ArrayList<Integer[]> incMatrix) {
    ...
    public MyProcessModel removeAllIPsAndRepair(MyProcessModel inputPM, ArrayList<ArrayList<Integer>> relevantTraceVariants) {
        System.out.println("ERROR: IP Removal with repair not imlemented!");
        // TODO Auto-generated method stub
        return null;
    }

    public Object[] implicitAndRepairRelatedToPlace(MyPlace specificPlace, ArrayList<MyPlace> placesToCheck, ArrayList<ArrayList<Integer>> relevantTraceVariants) {
        System.out.println("ERROR: IP Removal with repair not imlemented!");
        // TODO Auto-generated method stub
        return null;
    }
