...
public class AvoidManyOneLoopsFiringSequenceChooser extends AbstractFiringSequenceChooser {
    ...
    public void init(Collection<Place> places, Marking initMarking) {
        ...
        for (Place p : oneLoopingPlaces) {
            malusOfPlaces.put(p, 1 << (numbOfOneLoopingTransitions.get(p) << 1));
        }
    }
    ...
    public String toString() {
        return "Avoid tokens completely in places with many one-loops.";
    }
}
